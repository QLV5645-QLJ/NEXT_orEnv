...
if __name__ == '__main__':
    ...
    obs_aabb = [[[0.5, -0.4, -0.05], [0.6, -0.3, 0.05]], [[0.5, -0.4, 0.05], [0.6, -0.3, 0.15]], [[0.9, -0.2, -0.05], [1.0, -0.1, 0.05]], [[0.5, 0.2, -0.05], [0.6, 0.3, 0.05]], [[0.7, 0.3, -0.05], [0.8, 0.4, 0.05]]]
    obs_aabb = [[[0.6, 0.2, -0.05], [0.7, 0.3, 0.05]], [[0.6, 0.2, 0.05], [0.7, 0.3, 0.15]], [[0.5, -0.1, -0.05], [0.6, -0.0, 0.05]], [[0.6, -0.6, -0.05], [0.7, -0.5, 0.05]], [[0.9, -0.2, -0.05], [1.0, -0.1, 0.05]], [[0.7, -0.4, -0.2], [1.0, 0.6, -0.3]]]
    obs_aabb = [[[0.5, -0.3, 0.0], [0.6, -0.2, 0.1]], [[0.5, -0.3, 0.1], [0.6, -0.2, 0.2]], [[0.5, -0.3, 0.2], [0.6, -0.2, 0.3]], [[0.5, -0.4, 0.0], [0.6, -0.3, 0.1]], [[0.5, 0.2, 0.0], [0.6, 0.3, 0.1]], [[0.5, -0.7, -0.1], [1.0, 0.7, 0.0]]]
    obs_aabb = [[[0.7, -0.3, 0.0], [0.8, -0.2, 0.1]], [[0.9, -0.5, 0.0], [1.0, -0.4, 0.1]], [[0.5, 0.4, 0.0], [0.6, 0.5, 0.1]], [[0.8, -0.6, 0.0], [0.9, -0.5, 0.1]], [[0.7, 0.1, 0.0], [0.8, 0.2, 0.1]], [[0.5, -0.7, -0.1], [1.0, 0.7, 0.0]]]
    obs_aabb = [[[0.6, -0.2, 0.0], [0.7, -0.1, 0.1]], [[0.6, -0.2, 0.1], [0.7, -0.1, 0.2]], [[0.6, -0.2, 0.2], [0.7, -0.1, 0.3]], [[0.6, 0.5, 0.0], [0.7, 0.6, 0.1]], [[0.8, -0.1, 0.0], [0.9, -0.0, 0.1]], [[0.5, -0.7, -0.1], [1.0, 0.7, 0.0]]]
    obs_aabb = [[[0.0, 0.6, 0.3], [0.1, 0.7, 0.4]], [[0.0, 0.6, 0.4], [0.1, 0.7, 0.5]], [[0.0, 0.6, 0.5], [0.1, 0.7, 0.6]], [[0.4, -0.6, 0.0], [0.5, -0.5, 0.1]], [[0.7, -0.4, 0.0], [0.8, -0.3, 0.1]], [[-0.3, 0.4, 0.2], [0.3, 1.0, 0.3]], [[-0.3, 0.4, 0.9], [0.3, 1.0, 1.0]], [[-0.3, 0.4, -0.8], [0.3, 1.0, -0.7]], [[-0.35, 0.4, -1.0], [-0.25, 1.0, 1.0]], [[0.25, 0.4, -1.0], [0.35, 1.0, 1.0]], [[0.5, -0.9, -0.1], [1.0, 0.5, 0.0]]]
    obs_aabb = [[[-0.1, 0.7, 0.3], [-0.0, 0.8, 0.4]], [[-0.1, 0.7, 0.4], [-0.0, 0.8, 0.5]], [[-0.1, 0.7, 0.5], [-0.0, 0.8, 0.6]], [[0.5, -0.5, 0.0], [0.6, -0.4, 0.1]], [[0.7, -0.5, 0.0], [0.8, -0.4, 0.1]], [[-0.3, 0.4, 0.2], [0.3, 1.0, 0.3]], [[-0.3, 0.4, 0.9], [0.3, 1.0, 1.0]], [[-0.3, 0.4, -0.8], [0.3, 1.0, -0.7]], [[-0.4, 0.4, -1.0], [-0.3, 1.0, 1.0]], [[0.3, 0.4, -1.0], [0.4, 1.0, 1.0]], [[0.5, -0.9, -0.1], [1.0, 0.5, 0.0]]]
    map = gridMap(width=width,resolution=resolution)
    for aabb in obs_aabb:
        map.add_obstacle(aabb)
    visulaize_map(map.get_map())